...
import { detailPlaylist, getAllPlaylists, hapusPlaylist } from "@/app/actions/kelolaPlaylist";
...
const PlayPlaylist = ({ params }: { params: { detailPlaylistId: string } }) => {
    ...
    const { judul_playlist, nama_pembuat, deskripsi,id_user_playlist, jumlah_lagu, tanggal_dibuat, total_durasi, judul_lagu, id_song } = playlistData[0] || {};
    return (
        <div className="flex min-h-screen bg-white text-white-100 flex-col items-center justify-center gap-16 font-bold p-48">
            ...
            <div className="flex flex-col gap-8 w-full justify-center items-center mt-8">
                ...
                <button 
                    onClick={() => router.push(`/kelola_playlist/${params.detailPlaylistId}`)}
